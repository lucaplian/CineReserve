...
public class BookingController(ILogger<BookingController> logger,  IBookingService BookingService) 
    : BaseResponseController(logger) 
{
    ...
    public async Task<ActionResult<RequestResponse<BookingRecord>>> GetById([FromRoute] Guid id) // The FromRoute attribute will bind the id from the route to this parameter.
    {
        ...
        {
            ErrorMessageResult<FeedbackRecord>(new(HttpStatusCode.Unauthorized, "Unauthorized!"));
        }
        return FromServiceResponse(await BookingService.GetBooking(id, userId));
    }
    ...
    // the PaginationSearchQueryParams properties to the object in the method parameter.
    {
        ...
        return FromServiceResponse(await BookingService.GetBookings(pagination, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Add([FromBody] BookingAddRecord Booking)
    {
        ...
        if (userId == Guid.Empty)
        {
            ErrorMessageResult<FeedbackRecord>(new(HttpStatusCode.BadRequest, "Unauthorized!"));
        }

        return FromServiceResponse(await BookingService.AddBooking(Booking, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Update([FromBody] BookingUpdateRecord Booking)  // The FromBody attribute indicates that the parameter is deserialized from the JSON body.
    {
        ...
        return FromServiceResponse(await BookingService.UpdateBooking(Booking, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Delete([FromRoute] Guid id) // The FromRoute attribute will bind the id from the route to this parameter.
    {
        ...
        return FromServiceResponse(await BookingService.DeleteBooking(id, userId));
    }
