    ...
    : BaseResponseController(logger)
{
    ...
    {
        return FromServiceResponse(await FeedbackService.GetFeedback(id));
    }
    ...
    {
        return FromServiceResponse(await FeedbackService.GetFeedbacks(pagination));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Add([FromBody] FeedbackAddRecord Feedback)
    {
        ...
        return FromServiceResponse(await FeedbackService.AddFeedback(Feedback, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Update([FromBody] FeedbackUpdateRecord Feedback)  // The FromBody attribute indicates that the parameter is deserialized from the JSON body.
    {
        ...
        return FromServiceResponse(await FeedbackService.UpdateFeedback(Feedback, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Delete([FromRoute] Guid id) // The FromRoute attribute will bind the id from the route to this parameter.
    {
        ...
        return FromServiceResponse(await FeedbackService.DeleteFeedback(id, userId));
    }
