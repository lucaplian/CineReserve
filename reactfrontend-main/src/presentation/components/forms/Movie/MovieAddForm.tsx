...
import { useMovieAddFormController } from "./MovieAddForm.controller";
 ...
 */
export const MovieAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useMovieAddFormController(props.onSubmit); // Use the controller.
