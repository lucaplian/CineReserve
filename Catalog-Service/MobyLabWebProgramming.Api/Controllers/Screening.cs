...
public class ScreeningController(ILogger<ScreeningController> logger, IScreeningService ScreeningService) : BaseResponseController(logger)
{
    ...
    public async Task<ActionResult<RequestResponse<ScreeningRecord>>> GetById([FromRoute] Guid id) // The FromRoute attribute will bind the id from the route to this parameter.
    {
        ...
        return FromServiceResponse(await ScreeningService.GetScreening(id));
    }
    ...
    // the PaginationSearchQueryParams properties to the object in the method parameter.
    {
        ...
        return FromServiceResponse(await ScreeningService.GetScreenings(pagination));
    ...
    public async Task<ActionResult<RequestResponse>> Add([FromBody] ScreeningAddRecord Screening)
    {
        ...
        return FromServiceResponse(await ScreeningService.AddScreening(Screening, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Update([FromBody] ScreeningUpdateRecord Screening)  // The FromBody attribute indicates that the parameter is deserialized from the JSON body.
    {
        ...
        return FromServiceResponse(await ScreeningService.UpdateScreening(Screening, userId));
    }
    ...
    public async Task<ActionResult<RequestResponse>> Delete([FromRoute] Guid id) // The FromRoute attribute will bind the id from the route to this parameter.
    {
        ...
        return FromServiceResponse(await ScreeningService.DeleteScreening(id, userId));
    }
