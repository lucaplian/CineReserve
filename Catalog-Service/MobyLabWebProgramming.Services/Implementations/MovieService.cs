...
public class MovieService(IRepository<WebAppDatabaseContext> repository, AuthServiceClient authServiceClient): IMovieService
{
    ...
    public async Task<ServiceResponse> AddMovie(MovieAddRecord movie, Guid UserId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> UpdateMovie(MovieUpdateRecord movie, Guid UserId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> DeleteMovie(Guid id, Guid UserId, CancellationToken cancellationToken = default)
    {
