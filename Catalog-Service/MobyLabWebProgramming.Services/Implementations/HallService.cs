...
public class HallService(IRepository<WebAppDatabaseContext> repository, AuthServiceClient authServiceClient): IHallService
{
    ...
    public async Task<ServiceResponse> AddHall(HallAddRecord hall,  Guid UserId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> UpdateHall(HallUpdateRecord hall,  Guid UserId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> DeleteHall(Guid id,  Guid UserId, CancellationToken cancellationToken = default)
    {
