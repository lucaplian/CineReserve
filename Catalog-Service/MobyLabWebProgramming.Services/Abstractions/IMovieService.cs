...
public interface IMovieService
{
    ...
    public Task<ServiceResponse> AddMovie(MovieAddRecord movie, Guid UserId, CancellationToken cancellationToken = default);
    public Task<ServiceResponse> UpdateMovie(MovieUpdateRecord movie, Guid UserId, CancellationToken cancellationToken = default);
    public Task<ServiceResponse> DeleteMovie(Guid id, Guid UserId, CancellationToken cancellationToken = default);
