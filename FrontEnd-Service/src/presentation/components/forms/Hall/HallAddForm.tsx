...
import { useHallAddFormController } from "./HallAddForm.controller";
 ...
 */
export const HallAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useHallAddFormController(props.onSubmit); // Use the controller.
