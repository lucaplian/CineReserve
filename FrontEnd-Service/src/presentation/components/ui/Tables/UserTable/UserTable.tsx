 ...
 */
const useHeader = (): { key: keyof UserRecord, name: string, order: number }[] => {
 ...
 */
const getRowValues = (entries: UserRecord[] | null | undefined, orderMap: { [key: string]: number }) =>
    entries?.map(
        entry => {
            return {
                entry: entry,
                   ...
                   extraHeader={[
                    {
                        ...
                        render: (entry) => { 
                                                ...
                                                const roleTranslations = new Map([
                                                    ...
                                                    ["Personnel", "globals.personnel"],
                                                  
                                                ]);


                                                return <>{formatMessage({ id: roleTranslations.get(entry.role) })}</>;
