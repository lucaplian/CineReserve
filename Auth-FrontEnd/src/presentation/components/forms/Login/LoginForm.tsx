        ...
        <Stack spacing={4} style={{ width: "100%" }}>
            <ContentCard title={formatMessage({ id: "globals.login" })}>
                <div className="grid grid-cols-2 gap-y-5 gap-x-5">
                    ...
                    <button style={{ justifyContent: "left" , color: "gray", backgroundColor: "white", borderColor:"white", fontSize:"12px"}} type="button" onClick={() =>actions.createAccount()}  disabled={!isEmpty(state.errors) || computed.isSubmitting}> {/* Add a button with type submit to call the submission callback if the button is a descended of the form element. */}
                        
                        <FormattedMessage id="globals.make_account"  />
                    </button>
