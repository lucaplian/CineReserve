...
export function instanceOfHttpStatusCode(value: any): boolean {
    for (const key in HttpStatusCode) {
        if (Object.prototype.hasOwnProperty.call(HttpStatusCode, key)) {
            if (HttpStatusCode[key as keyof typeof HttpStatusCode] === value) {
                return true;
            }
        }
    }
...
export function HttpStatusCodeToJSONTyped(value: any, ignoreDiscriminator: boolean): HttpStatusCode {
    return value as HttpStatusCode;
}
