...
public class ScreeningService(IRepository<WebAppDatabaseContext> repository) : IScreeningService
{
    ...
    public async Task<ServiceResponse> AddScreening(ScreeningAddRecord screening, UserRecord? requestingUser = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> UpdateScreening(ScreeningUpdateRecord screening, UserRecord? requestingUser = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<ServiceResponse> DeleteScreening(Guid id, UserRecord? requestingUser = null, CancellationToken cancellationToken = default)
    {
        if (requestingUser != null && requestingUser.Role != UserRoleEnum.Admin)
        {
